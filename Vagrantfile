...
Vagrant.configure("2") do |config|
  ...
  #TODO CHECK THIS LATER (shared folders for data backup)
  #scripts_folder = "/tmp/dendro_setup_scripts/2016-07-21_18_49_53_0100"
  #config.vm.synced_folder "~/Desktop/scripts_deployment", scripts_folder, create:false
