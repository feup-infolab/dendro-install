...
sudo apt-get update
sudo apt-get -y -f -qq install md5 devscripts autoconf automake libtool flex bison gperf gawk m4 make libssl-dev git imagemagick subversion zip htop redis-server nodejs npm htop --fix-missing || die "Failed to install preliminary dependencies. Please check any prior error messages."
